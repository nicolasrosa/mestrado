...
class Metrics():
    def __init__(self):
        self.Threshold_hist = []
        self.AbsRelativeDifference_hist = []
        self.SquaredRelativeDifference_hist = []
        self.RMSE_linear_hist = []
        self.RMSE_log_hist = []
        self.RMSE_log_scaleInv_hist = []
    ...
    def tf_RMSE_log_scaleInv(y, y_):
        ...
        print()
        print("tf.reduce_sum(tf.log(tf_y_)-tf.log(tf_y)): ", sess.run([tf.reduce_sum(tf.log(tf_y_)-tf.log(tf_y))],feed_dict=feed_dict))
        print()
        print("tf.reduce_sum(tf.log(tf_y_)-tf.log(tf_y))/tf_npixels_valid_float32: ", sess.run([tf.reduce_sum(tf.log(tf_y_)-tf.log(tf_y))/tf_npixels_valid_float32],feed_dict=feed_dict))
        print()
        print("tf.log(tf_y)-tf.log(tf_y_): ", sess.run([tf.log(tf_y)-tf.log(tf_y_)],feed_dict=feed_dict))
        print()
        print("tf.log(tf_y)-tf.log(tf_y_)+tf_alfa: ", sess.run([tf.log(tf_y)-tf.log(tf_y_)+tf_alfa],feed_dict=feed_dict))
        print()
        print("tf.pow(tf.log(tf_y)-tf.log(tf_y_)+tf_alfa,2): ", sess.run([tf.pow(tf.log(tf_y)-tf.log(tf_y_)+tf_alfa,2)],feed_dict=feed_dict))
        print()
        print("tf.reduce_sum(tf.pow(tf.log(tf_y)-tf.log(tf_y_)+tf_alfa,2)): ", sess.run([tf.reduce_sum(tf.pow(tf.log(tf_y)-tf.log(tf_y_)+tf_alfa,2))],feed_dict=feed_dict))
        print()
        print("tf.reduce_sum(tf.pow(tf.log(tf_y)-tf.log(tf_y_)+tf_alfa,2))/tf_npixels_valid_float32: ", sess.run([tf.reduce_sum(tf.pow(tf.log(tf_y)-tf.log(tf_y_)+tf_alfa,2))/tf_npixels_valid_float32],feed_dict=feed_dict))
